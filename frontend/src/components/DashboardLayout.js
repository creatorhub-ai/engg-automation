...
const MENUS_BY_ROLE = {
  admin: [
    { id: 16, name: "Classroom Planner", path: "/classroom-planner" },
    ...
    { id: 13, name: "Attendance", path: "/attendance" },
    { id: 21, name: "Mark Entry", path: "marks/entry"},
    { id: 14, name: "Mark Entry", path: "/marks-entry" },
    { id: 20, name: "Marks Dashboard", path: "/marks-dashboard" },
